...
#      Version: 0.0.1
#   LastChange: 2013-11-02 00:07:55
#      History:
                本类基于网上开源版本，
                增加getValue获取单个值函数
#=============================================================================
...
class Connection(object):
    ...
    def getValue(self,query,*parameters):
        """Returns the first row first column values"""
        dic = self.get(query,*parameters)
        if dic:
            return dic.values()[0]
        else:
            return None
